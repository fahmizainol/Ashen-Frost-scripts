...
class PokemonStorageScene
  def pbUpdateOverlay(selection, party = nil)
    ...
    if !pokemon.egg?
      imagepos = []
      if pokemon.male?
        textstrings.push([_INTL("♂"), 158, 14, false, Color.new(24, 112, 216), Color.new(136, 168, 208)])
      elsif pokemon.female?
        textstrings.push([_INTL("♀"), 158, 14, false, Color.new(248, 56, 32), Color.new(224, 152, 144)])
      end
      ...
      if pokemon.shiny?
        pbDrawImagePositions(plugin_overlay, [["Graphics/Pictures/shiny", 138, 16]])
      end
