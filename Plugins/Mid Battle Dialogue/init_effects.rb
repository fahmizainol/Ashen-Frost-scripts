...
class Battle::Battler
  alias dialogue_initeffect pbInitEffects
  def pbInitEffects(batonPass)
    dialogue_initeffect(batonPass)
    @effects[PBEffects::Highhp]             = false
    @effects[PBEffects::Midhp]              = false
    @effects[PBEffects::Lowhp]              = false
    @effects[PBEffects::BossProtect]    = false
  end
end