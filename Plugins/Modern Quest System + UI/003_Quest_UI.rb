...
class QuestList_Scene
  ...
  def drawQuestDesc(quest)
    ...
    drawFormattedTextEx(@sprites["overlay3"].bitmap,38,352, #Was 320
      436,"<c2=#{colorQuest("orange")}></c2> #{questStageDesc}",@base,@shadow) #Ekat Note: Changed this from "Task:"
    drawFormattedTextEx(@sprites["overlay3"].bitmap,38,320, #was 352
...
###
    ...
    drawFormattedTextEx(@sprites["overlay3"].bitmap,38,Graphics.height-64,
      436,"<c2=#{colorQuest("red")}></c2> #{questReward}",@base,@shadow) #Ekat Note: Got rid of the "reward" text
