...
class PokemonStorage
  ...
  def allWallpapers
    return [
      # Basic wallpapers
      _INTL("Delibird"), _INTL("Swinub"), _INTL("Riverview"), _INTL("Snow"),
      _INTL("Icy Cave"), _INTL("Flannel"), _INTL("Lugia"), _INTL("Space"), _INTL("Lugia Retro"),
      # Special wallpapers
      _INTL("Piloswine"), _INTL("Lonardo"), _INTL("Articuno"), _INTL("Mamoswine"),
      _INTL("Serenity"), _INTL("Lafayette"), _INTL("Moltres"), _INTL("Sandshrew"),
      _INTL("Sandslash"), _INTL("Zangoose"), _INTL("Zapdos"), _INTL("Fogdale"),
      _INTL("Mossy Cave"), _INTL("Morove"), _INTL("Stakataka"), _INTL("Distortion"),
      _INTL("Giratina"), _INTL("Castaway"), _INTL("Pumpkin"), _INTL("Apathy"),
      _INTL("Nightshade"), _INTL("Seafoam"), _INTL("Halcyon")
    ]
  end
