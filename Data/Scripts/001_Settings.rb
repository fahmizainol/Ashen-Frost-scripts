...
module Settings
  ...
  #$DEBUG = true #Ekat Note: Make sure to set this to false before releasing the game
  ...
  SHINY_POKEMON_CHANCE = (MECHANICS_GENERATION >= 6) ? 1556 : 1556
  ...
  TIME_SHADING                               = false #Ekat note - disabled day night shading for my sanity's sake
  ...
  BADGE_FOR_CUT       = 99
  BADGE_FOR_FLASH     = 99
  BADGE_FOR_ROCKSMASH = 99
  BADGE_FOR_SURF      = 99
  BADGE_FOR_FLY       = 99
  BADGE_FOR_STRENGTH  = 99
  BADGE_FOR_DIVE      = 99
  BADGE_FOR_WATERFALL = 99
  ...
  REGION_MAP_EXTRAS = [
    [2,412, 6, 4,"redcross",false], # Shipyard
    [2,413, 6, 7,"redcross",false], # Freightroom
    [2,414,15, 3,"redcross",false], # Greenhouse 
    [2,415, 6,13,"redcross",false], # Lab Entrance
    [2,416,14,12,"redcross",false], # Doctor's Office 
    [2,417,10,15,"redcross",false], # Neon's Room 
    [2,418,20,16,"redcross",false], # Store Room 
    [2,419,26,14,"greencross",false], # Deep Freezer
    [2,124,25,5,"mapHiddenSerenity",false]
  ]
  ...
  # it can lead to.
  ROAMING_AREAS = {
    490  => [491,492,493,500,501,502,503,504,505,506,512],
    491  => [490,492,493,500,501,502,503,504,505,506,512],
    492  => [490,491,493,500,501,502,503,504,505,506,512],
    493  => [490,491,492,500,501,502,503,504,505,506,512],
    500  => [490,491,492,493,501,502,503,504,505,506,512],
    501  => [490,491,492,493,500,502,503,504,505,506,512],
    502  => [490,491,492,493,500,501,503,504,505,506,512],
    503  => [490,491,492,493,500,501,502,504,505,506,512],
    504  => [490,491,492,493,500,501,502,503,505,506,512],
    505  => [490,491,492,493,500,501,502,503,504,506,512],
    506  => [490,491,492,493,500,501,502,503,504,505,512],
    512  => [490,491,492,493,500,501,502,503,504,505,506],
    788  => []
  }
  ...
  ROAMING_SPECIES = [
    [:DURALUDON, 60, 244, 1, "Morrigan Theme", {
      490  => [491,492,493,500,501,502,503,504,505,506,512],
      491  => [490,492,493,500,501,502,503,504,505,506,512],
      492  => [490,491,493,500,501,502,503,504,505,506,512],
      493  => [490,491,492,500,501,502,503,504,505,506,512],
    ...
    [:REUNICLUS, 55, 402, 1, "Paradigm Shift (Techno Remix)", {
      788  => []
    }]
  ]
  ...
  # The Game Switch which, while ON, makes all wild Pokémon created be male.
  MALE_WILD_POKEMON_SWITCH = 146
