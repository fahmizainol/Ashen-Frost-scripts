...
def pbStartOver(gameover = false)
  ...
  if $PokemonGlobal.pokecenterMapId && $PokemonGlobal.pokecenterMapId >= 0
    if gameover
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]After the unfortunate defeat, you scurry back to a safe place."))
    else
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]You scurry back to a safe place, protecting your exhausted Pokémon from any further harm..."))
    end
    pbCancelVehicles
    Followers.clear
    $game_switches[149] = false if $game_switches[149]
