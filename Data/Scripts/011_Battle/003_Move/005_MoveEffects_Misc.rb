...
#===============================================================================
# Does absolutely nothing. Shows a special message. (Blink)
#===============================================================================
class Battle::Move::DoesNothingBlink < Battle::Move
  def pbEffectGeneral(user)
    if user.wild?
      @battle.pbDisplay(_INTL("Blink!", user.pbThis(true)))
    else
      @battle.pbDisplay(_INTL("Blink!", @battle.pbGetOwnerName(user.index)))
    end
  end
end

#===============================================================================
# Does absolutely nothing. Shows a special message. (Creepy Noise)
#===============================================================================
class Battle::Move::DoesNothingCreepyNoise < Battle::Move
  def pbEffectGeneral(user)
    if user.wild?
      @battle.pbDisplay(_INTL("A creepy noise is made!", user.pbThis(true)))
    else
      @battle.pbDisplay(_INTL("A creepy noise is made!", @battle.pbGetOwnerName(user.index)))
    end
  end
end

#===============================================================================
# Does absolutely nothing. Shows a special message. (Undulate)
#===============================================================================
class Battle::Move::DoesNothingUndulate < Battle::Move
  def pbEffectGeneral(user)
    if user.wild?
      @battle.pbDisplay(_INTL("It shimies in place!", user.pbThis(true)))
    else
      @battle.pbDisplay(_INTL("It shimies in place!", @battle.pbGetOwnerName(user.index)))
    end
  end
end

#===============================================================================
# Does absolutely nothing. Shows a special message. (Stare)
#===============================================================================
class Battle::Move::DoesNothingStare < Battle::Move
  def pbEffectGeneral(user)
    if user.wild?
      @battle.pbDisplay(_INTL("It stares deep into your soul!", user.pbThis(true)))
    else
      @battle.pbDisplay(_INTL("It stares deep into your soul!", @battle.pbGetOwnerName(user.index)))
    end
  end
end
