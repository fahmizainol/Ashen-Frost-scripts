...
class PokemonBag_Scene
  ...
  ITEMTEXTBASECOLOR     = Color.new(234, 234, 234)
  ITEMTEXTSHADOWCOLOR   = Color.new(99, 99, 127)
  ...
  #  pbQolTutorials("BagSorting") # Changed by DemICE 16-Dec-2023 adding tutorials to the game.
  end
  ...
  def pbRefreshIndexChanged
    ...
    overlay.clear
    # Draw the pocket name (Ekat note: commented out bag pocket name text) (ex: medicine, tms, etc.)
    pbDrawTextPositions(
      overlay,
      [[PokemonBag.pocket_names[@bag.last_viewed_pocket - 1], 94, 16, 2, POCKETNAMEBASECOLOR, POCKETNAMESHADOWCOLOR], 
      ["F: Sort", 94, 154, 2, POCKETNAMEBASECOLOR, POCKETNAMESHADOWCOLOR]] #186
    )
    # Draw slider arrows
    showslider = false
    ...
    pbActivateWindow(@sprites, "itemlist") {
      loop do
        ...
        if itemwindow.sorting
          ...
          elsif Input.trigger?(Input::AUX2) # DemICE alphabetical Bag Sorting
...
# DemICE alphabetical Bag Sorting
class PokemonBag
