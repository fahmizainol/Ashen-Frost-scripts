...
class ButtonEventScene < EventScene
  def initialize(viewport = nil)
    ...
    addImageForScreen(5, 16, 90, "Graphics/Pictures/Controls help/help_speed")
    addImageForScreen(5, 16, 236, "Graphics/Pictures/Controls help/help_skip")
    addLabelForScreen(5, 134, 68, 352, _INTL("Used to speed the game up. There are two higher speeds which can be toggled. (Default: Q)"))
    addLabelForScreen(5, 134, 196, 352, _INTL("Used to skip dialogue. Handle with care! (Default: X)"))
