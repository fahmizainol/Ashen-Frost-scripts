...
class PokemonBoxPartySprite < Sprite
  ...
  def refresh
    ...
    pbDrawTextPositions(
      self.bitmap,
      [[_INTL("Back"), 86, 248, 2, Color.new(248, 248, 248), Color.new(66, 66, 66), 1]]
    )
...
class PokemonStorageScene
  ...
  def pbUpdateOverlay(selection, party = nil)
    ...
    buttonshadow = Color.new(66, 66, 66)
    pbDrawTextPositions(
      overlay,
    ...
    if !pokemon.egg?
      ...
      if pokemon.shiny?
        imagepos.push(["Graphics/Pictures/shiny", 140, 198])
      end
