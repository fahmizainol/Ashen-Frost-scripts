...
def pbGenerateChallenge(rule, tag)
  ...
  yield(nil)
  party = load_data("Data/" + tag + ".rxdata") rescue []
  teams = load_data("Data/" + tag + "_teams.rxdata") rescue []
  if teams.length < 10
  ...
  iterations.times do |iter|
    save_data(party, "Data/" + tag + ".rxdata")
    ...
    save_data(teams, "Data/" + tag + "_teams.rxdata")
    yield(nil)
