...
GameData::Weather.register({
  ...
  :id_number        => 4,
  :category         => :Hail,
  :graphics         => [["blizzard_1", "blizzard_2", "blizzard_3", "blizzard_4"]],
...
GameData::Weather.register({
  ...
  :id_number        => 5,
  :category         => :Sandstorm,
  :graphics         => [["sandstorm_1", "sandstorm_2", "sandstorm"]],
  :particle_delta_x => -240,
  :particle_delta_y => 240,
#  :tone_proc        => proc { |strength|
#    next Tone.new(strength / 2, strength / 2, strength / 2, 0)
...
# Ekat Note: Added ash animation, consulted with the Micahel in order to implement this. 
GameData::Weather.register({
  :id               => :Ash,
  :id_number        => 10,   
  :category         => :None,
  :graphics         => [["ash_1", "ash_2", "ash_3"]],
  :particle_delta_x => -140,
  :particle_delta_y =>  140,
})
...
GameData::Weather.register({
  ...
  :id_number        => 12,   
  :category         => :Rain,
  :graphics         => [["rain_1", "rain_4"]],   # Last is splash
  :particle_delta_x => -1200,
  :particle_delta_y => 4800,
  :tone_proc        => proc { |strength|
    next Tone.new(-strength * 3 / 4, -strength * 3 / 4, -strength * 3 / 4, 10)
