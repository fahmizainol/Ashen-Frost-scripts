...
GameData::BattleWeather.register({
  :id        => :FreezingRain,
  :name      => _INTL("Freezing Rain"),
  :animation => "FreezingRain"
})

GameData::BattleWeather.register({
  :id        => :FrozenStorm,
  :name      => _INTL("Frozen Thunderstorm"),
  :animation => "FrozenStorm"
})

GameData::BattleWeather.register({
  :id        => :HolyInferno,
  :name      => _INTL("Holy Inferno"),
  :animation => "HolyInferno"
})

GameData::BattleWeather.register({
  :id        => :SolarWinds,
  :name      => _INTL("Solar Winds"),
  :animation => "SolarWinds"
})
