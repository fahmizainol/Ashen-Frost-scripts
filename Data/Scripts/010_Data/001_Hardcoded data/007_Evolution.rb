...
GameData::Evolution.register({
  ...
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.level >= parameter && $game_screen &&
         [:Rain, :Fog, :FreezingRain, :FrozenStorm].include?(GameData::Weather.get($game_screen.weather_type).category)
  }
})
...
GameData::Evolution.register({
  ...
  :level_up_proc => proc { |pkmn, parameter|
    next pkmn.level >= parameter && $game_screen &&
    [:Hail, :Snow, :FreezingRain, :FrozenStorm].include?(GameData::Weather.get($game_screen.weather_type).category)
  }
})
